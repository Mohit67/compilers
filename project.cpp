...
/*		list<arg_node *>::iterator itr;
		for(itr=agl->begin();itr!=agl->end();itr++)
		{
			cout << (*itr)->type_ << *(*itr)->id_ << endl;
		}
*///		printf("in method\n");
	}
	void method_node::print_()
	{
		cout << type_ << " " << id_ << " ( ";/* << agl_->print_() << " ) " << endl << blk_->print_()*/
		list<arg_node *>::iterator itr;
		itr=agl_->begin();
		if(*itr!=NULL)
		{
...
//		printf("in block\n");
	...
	void block_node::print_()					/* changing adding this class */
	{
...
//		printf("in variable\n");
	...
	void variable_node::print_()		/*changing added this class*/
	{
		cout << type_ << " ";
...
//		printf("in id\n");
	...
	void id_node::print_()					/*changing added this class*/
	{
		cout << id_;
	}
...
//		printf("in statement\n");
	...
	void statement_node::print_()				/*changing adding class*/
	{
...
//		printf("in continue_stmt\n");
	...
	{
	//	printf("in literal_node\n");
	}
	int_literal_node::int_literal_node(int iln)
	{	
		iln_ = iln;
	//	printf("in int_literal_node\n");
	}
